...
export const iconSetTemplate = html`
  <custom-icon-set>
    <template>
      ...
      <span name="picture_as_pdf">@symbol-picture_as_pdf</span>
      <span name="print">@symbol-print</span>
      <span name="data_object">@symbol-data_object</span>
      ...
      <span name="account_tree">@symbol-account_tree</span>
      <span name="dataset">@symbol-dataset</span>
      ...
      <span name="outlet">@symbol-outlet</span>
      <span name="electric_bolt">@symbol-electric_bolt</span>
      <span name="toggle_on">@symbol-toggle_on</span>
      <span name="switch_left">@symbol-switch_left</span>
      <span name="linear_scale">@symbol-linear_scale</span>
      <span name="toggle_off">@symbol-toggle_off</span>
      <span name="settings">@symbol-settings</span>
      <span name="view_week">@symbol-view_week</span>
      <span name="power">@symbol-power</span>
      <span name="skip_next">@symbol-skip_next</span>
      <span name="dashboard">@symbol-dashboard</span>
      <span name="align_horizontal_left">@symbol-align_horizontal_left</span>
